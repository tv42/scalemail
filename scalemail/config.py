...
class ScalemailConfig:
    ...
    def getLDAPAttributeAway(self):
        return self.config.get('Scalemail', 'ldap-attribute-away')

    def getLDAPAttributeFullName(self):
        return self.config.get('Scalemail', 'ldap-attribute-fullname')
